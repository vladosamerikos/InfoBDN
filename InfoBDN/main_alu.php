...
<body>
    <?php
       ...
       if (isset($_SESSION["email"]) && $_SESSION["role"]=="alum"){
        ...
        $sql = "SELECT * FROM cursos WHERE Data_inici>'$fechaActual' and Actiu like 'si' and Codi NOT IN ( SELECT Codi_curs FROM matricula WHERE DNI_alum like '$dni') ORDER BY Data_inici ASC LIMIT 5";
