...
<body>
    ...
    if ($_POST) {
        ...
        if ($usu == 'alum') {
            ...
            $sql = "SELECT * FROM professor WHERE Actiu like 'si' and Mail like '$email' AND password like '$md5pass' ";
            // Ejecutamos la sentencia
            $consulta = mysqli_query($bddcon, $sql);
            // Controlamos posibles errores
            if (!$consulta) {
                ...
                if ($num_rows == 1) {
                    ...
                    echo "<p>Les dades són incorrectes o el professor esta desactivat!</p>";
                    echo "<p>Intenta de nou ...</p>";
                    echo "<META HTTP-EQUIV='REFRESH' CONTENT='1.5;URL=index.php'>";
                }
            }
